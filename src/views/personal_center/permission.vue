  ...
  <div class="app-container">
    <el-form  ref="roleInfo" :model="roleInfo" label-width="80px" >
      <el-form-item label="角色信息" prop="role">
        <el-col :span="10">
          <el-select v-model="roleInfo.role" clearable placeholder="请选择设备组" @change="getPermissionList(roleInfo.role)" style="width: 100%;">
            <el-option v-for="role in roleInfo.roleArr" :key="role.role_id" :label="role.group_name" :value="role.role_id"></el-option>
          </el-select>
        </el-col>
      </el-form-item>
      <el-row>
